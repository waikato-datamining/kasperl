...
class MetaDataFromName(Filter):
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Extracts a sub-string from the name or path and stores it in the meta-data."
    ...
    def _create_argparser(self) -> argparse.ArgumentParser:
        ...
        parser.add_argument("-r", "--regexp", type=str, help="The regular expression apply to the name, with the 1st group being used as the meta-data value.", default=None, required=False)
    ...
    def _update(self, data):
        ...
        try:
            ...
            if self.source == SOURCE_NAME:
                if isinstance(data, NameSupporter):
                    source = data.get_name()
            elif self.source == SOURCE_PATH:
                if isinstance(data, SourceSupporter):
