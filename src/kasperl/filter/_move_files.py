...
class MoveFiles(BatchFilter, InputBasedVariableSupporter):
    """
    ...
    def _create_argparser(self) -> argparse.ArgumentParser:
        ...
        parser.add_argument("-t", "--target_dir", metavar="DIR", type=str, help="The directory to move the files to. " + variable_list(obj=self), required=True)
        return parser
